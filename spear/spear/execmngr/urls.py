...
urlpatterns = patterns('execmngr.views',
    url(r'^add_node/$', NodeView.as_view(), name='add_node'),
    ...
    url(r'^add_sshkey/$', SSHKeyView.as_view(), name='add_sshkey'),
    url(r'^delete_sshkey/(?P<pk>\d+)/$', SSHKeyDelete.as_view(context_object_name='sshkey'), name='delete_sshkey'),
